...
const steps = [
    {
        ...
        title: "Enter URL",
        description:
            "Paste your website address to begin the process. Our system quickly scans your website structure, audience, and market presence.",
        image: "/vectors/amico-3.svg",
    },
    {
        number: "Step 2",
        title: "Generate",
        description:
            "Our intelligent engine analyzes your website, competitors, and industry signals to automatically generate and growth stage.",
        image: "/vectors/amico-4.svg",
    },
    {
        number: "Step 3",
        title: "Consult",
        description:
            "Review your generated strategy and connect with an expert if needed to refine insights, clarify priorities your team can confidently execute.",
        image: "/vectors/amico-5.svg",
    },
];

export function HowItWorksDIYSection() {
    ...
    return (
        <section id="how-it-works" className="bg-[#FFFFFF] relative overflow-hidden py-24 md:py-32">
